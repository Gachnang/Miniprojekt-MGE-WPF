...
namespace ch.hsr.wpf.gadgeothek.admin.View.Theme {
    public class ThemeProperties {
        ...
        /// <summary>
        ///     Gets the <see cref="Brush" /> of the control which will apply when mouseOver control, if one is present in the
        ///     template of the
        ///     specified element.
        /// </summary>
        ...
        /// <summary>
        ///     Gets the <see cref="Brush" /> of the control which will apply when control is pressed, if one is present in the
        ///     template of the
        ///     specified element.
        /// </summary>
        ...
        /// <summary>
        ///     Gets the <see cref="Brush" /> of the control which will apply when control has focus, if one is present in the
        ///     template of the
        ///     specified element.
        /// </summary>
        ...
        /// <summary>
        ///     Gets the <see cref="Brush" /> of the control which will apply when control is checked, if one is present in the
        ///     template of the
        ///     specified element.
        /// </summary>
